...
//    Override method
    public void actionPerformed(ActionEvent ae){
        ...
        String dob= ((Object) dobc.getDate()).toString() ;
        // String dob=((JTextField) dobc.getDate().getUiComponent()).getText() ;
        // String dob=((JTextField) dobc.getDateEditor().getUiComponent()).getText() ;
        // JTextField textField = (JTextField) dobc.getDateEditor().getUiComponent();
